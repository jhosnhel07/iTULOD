...
// Supabase platform, so neither needs to be in `supabase secrets set`. The
// SUPABASE_SECRET_KEY fallback is only for `supabase functions serve` locally,
// where secrets.env supplies it.
